...
export const CLAUDE_MODEL_TIERS = {
  OPUS: 'claude-3-opus-20240229', // Complex reasoning, high capability, data modeling
  SONNET: 'claude-3-5-sonnet-20241022', // Balanced capability, code generation, architecture
  HAIKU: 'claude-3-haiku-20240307', // Fast throughput, high-volume operations, messaging
} as const
